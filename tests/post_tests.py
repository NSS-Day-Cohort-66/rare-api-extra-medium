...
class PostTests(APITestCase):
    ...
    fixtures = ['user', 'token','rare_user', 'categories', 'posts', 'tags']
    ...
    def test_create_posts(self):
        ...
        self.assertEqual(json_response["rare_user"]["user"]["id"], self.user.id)
        self.assertEqual(json_response["category"]["label"], "Health")
        ...
        self.assertEqual(json_response["tags"], [{'id': 2, 'label': 'Sad'}, {'id': 3, 'label': 'Spooky'}])
